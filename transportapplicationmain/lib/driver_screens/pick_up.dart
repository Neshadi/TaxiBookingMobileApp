...
class PickUpPage extends StatefulWidget {
  ...
  const PickUpPage({required this.userRideRequestDetails, super.key});
...
class _PickUpPageState extends State<PickUpPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Pick-Up Details"),
      ),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10),
            Text(
                "Pick-Up Location: ${widget.userRideRequestDetails.originAddress}"),
            const SizedBox(height: 10),
            Text(
                "Destination: ${widget.userRideRequestDetails.destinationAddress}"),
            const SizedBox(height: 10),
            if (distance != null)
