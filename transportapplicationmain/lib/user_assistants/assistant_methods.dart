...
class AssistantMethods {
  ...
  static Future<String> getAccessToken() async {
    final serviceAccountJson = {
      ...
      "client_email":
          "trippo-pasindu-sandeep@trippo-ef847.iam.gserviceaccount.com",
      ...
      "client_x509_cert_url":
          "https://www.googleapis.com/robot/v1/metadata/x509/trippo-pasindu-sandeep%40trippo-ef847.iam.gserviceaccount.com",
  ...
  static Future<void> sendNotificationToSelectedDriver(
    ...
    String dropOffLocationLat = Provider.of<AppInfo>(context, listen: false)
        .userDropOffLocation!
        .locationLatitude
        .toString();
    String dropOffLocationLng = Provider.of<AppInfo>(context, listen: false)
        .userDropOffLocation!
        .locationLongitude
        .toString();
    String pickUpLocationLat = Provider.of<AppInfo>(context, listen: false)
        .userPickUpLocation!
        .locationLatitude
        .toString();
    String pickUpLocationLng = Provider.of<AppInfo>(context, listen: false)
        .userPickUpLocation!
        .locationLongitude
        .toString();
    ...
    String endPointFirebaseCloudMessaging =
        "https://fcm.googleapis.com/v1/projects/trippo-ef847/messages:send";
    ...
    final Map<String, dynamic> message = {
      "message": {
        ...
        "data": {
          ...
          "originAddress": Provider.of<AppInfo>(context, listen: false)
              .userPickUpLocation!
              .locationName,
          "destinationAddress": Provider.of<AppInfo>(context, listen: false)
              .userDropOffLocation!
              .locationName
        }
      }
