...
class DriverComing extends StatefulWidget {
  ...
  const DriverComing(
      {super.key, required this.driverId, required this.rideRequestId});
...
class _DriverComingState extends State<DriverComing> {
  ...
  void _locatePickUp() {
    if (pickUpLocationLatLng != null && _pickupIcon != null) {
      ...
      setState(() {
        _markers
            .removeWhere((marker) => marker.markerId.value == "pickUpMarker");
      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content:
                const Text("Your driver has arrived at the pickup location."),
            actions: [
              TextButton(
