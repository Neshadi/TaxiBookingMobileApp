  ...
  void _locateDestination() {
    ...
    setState(() {
      _markers.removeWhere(
          (marker) => marker.markerId.value == "destinationMarker");
    ...
    driverLocationRef.onValue.listen((event) async {
      if (event.snapshot.value != null) {
        ...
        if (pickUpLocationLatLng != null) {
          ...
          if (newGoogleMapController != null) {
            CameraPosition cameraPosition =
                CameraPosition(target: driverPosition, zoom: 14.0);
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
              "Your driver has arrived at the destination location."),
          actions: [
            TextButton(
              child: const Text("Ok"),
              onPressed: () {
