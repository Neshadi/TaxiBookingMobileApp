          ...
          children: [
            Column(
              children: [
                ...
                // ),
                Container(
                  color: Colors.amber.shade400, // Yellow background
                  width: double.infinity, // Full width of the screen
                  padding: const EdgeInsets.symmetric(
                    vertical: 35, // Increased vertical padding for more height
                    horizontal:
                        20, // Horizontal padding for spacing around the text
                  ),
                  child: Text(
                    "Forgot Password?",
                    style: TextStyle(
                      color: Colors
                          .black, // Text color inside the yellow background
                      fontSize: 25,
