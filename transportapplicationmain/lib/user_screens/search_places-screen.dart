  ...
  findPlaceAutoCompleteSearch(String inputText) async {
    if (inputText.length > 1) {
      ...
      if (responseAutoCompleteSearch["status"] == "OK") {
        ...
        print(
            "Error: ${responseAutoCompleteSearch["status"]}"); // Debug: Print API status
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor:
              darkTheme ? Colors.amber.shade400 : Colors.amber.shade400,
          ...
          title: Text(
            ...
            style: TextStyle(color: darkTheme ? Colors.black : Colors.black),
          ),
          elevation: 0.0,
        ),
        body: Column(
